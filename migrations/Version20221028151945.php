 ...
 */
final class Version20221028151945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prix (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, quantity_id INT NOT NULL, prix VARCHAR(255) NOT NULL, INDEX IDX_F7EFEA5E4584665A (product_id), INDEX IDX_F7EFEA5E7E8B4AFC (quantity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, name VARCHAR(150) NOT NULL, subtitle VARCHAR(255) DEFAULT NULL, slug VARCHAR(150) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(300) NOT NULL, degre VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, vue INT DEFAULT NULL, active INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', period VARCHAR(150) DEFAULT NULL, note INT DEFAULT NULL, INDEX IDX_B3BA5A5ABCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quantities (id INT AUTO_INCREMENT NOT NULL, quantity VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
