 ...
 */
final class Version20221020051920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prix (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, prix DOUBLE PRECISION NOT NULL, INDEX IDX_F7EFEA5E4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
